...
export class Color {
  ...
  set(r: Color | number | ColorName, g?: number, b?: number) {
    if (g === undefined && b === undefined) {
      ...
      else if (r && r.isColor) this.copy(r);
  ...
  setHex(hex: number, colorSpace: ColorSpace = SRGBColorSpace) {
    hex = Math.floor(hex);
  ...
  setRGB(r: number, g: number, b: number, colorSpace: ColorSpace = ColorManagement.workingColorSpace) {
    this.r = r;
    this.g = g;
    this.b = b;
  ...
  setHSL(h: number, s: number, l: number, colorSpace: ColorSpace = ColorManagement.workingColorSpace) {
  ...
  getHex(colorSpace: ColorSpace = SRGBColorSpace) {
  ...
  getHexString(colorSpace: ColorSpace = SRGBColorSpace) {
    return ('000000' + this.getHex(colorSpace).toString(16)).slice(-6);
  }

  getHSL(target: HslColor, colorSpace: ColorSpace = ColorManagement.workingColorSpace) {
    // h,s,l ranges are in 0.0 - 1.0
  ...
  getRGB(target: Color, colorSpace: ColorSpace = ColorManagement.workingColorSpace) {
    ColorManagement.fromWorkingColorSpace(_color.copy(this), colorSpace);
  ...
  getStyle(colorSpace: ColorSpace = SRGBColorSpace) {
    ColorManagement.fromWorkingColorSpace(_color.copy(this), colorSpace);
