...
import { mix, NormalNodes, OscNodes, range, TimerNodes } from '../src/nodes/Nodes.js';
...
function init() {
  ...
  material.colorNode = mix(NormalNodes.world, randomColors, OscNodes.sine(TimerNodes.local(0.1)));
