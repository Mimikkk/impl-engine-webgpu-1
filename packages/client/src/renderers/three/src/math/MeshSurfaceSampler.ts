...
export class MeshSurfaceSampler {
  ...
  weightAttribute: BufferAttribute | null;
  ...
  setRandomGenerator(randomFunction: () => number) {
    this.randomFunction = randomFunction;
    return this;
  }

  sample(targetPosition: Vector3, targetNormal: Vector3, targetColor: Color, targetUV: Vector2) {
  ...
  sampleFace(faceIndex: number, targetPosition: Vector3, targetNormal: Vector3, targetColor: Color, targetUV: Vector2) {
