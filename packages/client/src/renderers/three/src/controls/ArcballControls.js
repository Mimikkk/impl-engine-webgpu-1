      ...
      switch (operation) {
        ...
        case 'ROTATE':
          ...
          this._startCursorPosition.copy(
            this.unprojectOnTbSurface(this.camera, _center.x, _center.y, this.domElement, this._tbRadius),
          );
        ...
        case STATE.PAN:
          if (this.enablePan) {
            if (restart) {
              ...
              this._startCursorPosition.copy(
                this.unprojectOnTbPlane(this.camera, _center.x, _center.y, this.domElement),
              );
              if (this.enableGrid) {
                this.drawGrid();
              }
